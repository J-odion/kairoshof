...
import { ArrowRight, ChevronLeft, ChevronRight, Gift, Percent } from "lucide-react";
import CountdownTimer from "./CountdownTimer";

const LimitedOffersSlider = () => {
  ...
  const offers = [
    ...
    },
    {
      ...
      description: "Exclusive holiday pricing on luxury sustainable homes with premium amenities.",
      endDate: new Date("2025-12-25T23:59:59"),
      icon: Percent,
      gradient: "from-green-500/20 to-emerald-500/20",
      link: "/yuletide-special"
    },
    {
      id: 3,
      title: "Z-Korting Apartments",
      subtitle: "1 to 3 Bedrooms Available",
      discount: "Starting ₦15M",
      description: "Affordable luxury apartments with flexible payment plans and sustainable features.",
...
export default LimitedOffersSlider;